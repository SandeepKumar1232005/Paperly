...
- **Database**: Firebase Firestore (Production) / Mock Firestore (Local)
- **Authentication**: JWT (JSON Web Tokens) & Firebase Auth
- **AI Integration**: Google Generative AI (Gemini) & TensorFlow
...
- **`backend/`**: Contains the server-side Django API, integrated with Firebase Firestore.
