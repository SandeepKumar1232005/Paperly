...
=======
      <div className="p-2 bg-[var(--surface)] text-[var(--text-secondary)] rounded-lg">
>>>>>>> master
        <File size={20} />
      </div>
    );
...
=======
      className="fixed bottom-6 right-6 w-96 h-[500px] glass-card flex flex-col z-[200] overflow-hidden animate-in slide-in-from-bottom-4 duration-300 shadow-2xl"
...
=======
        className="flex-1 overflow-y-auto p-4 space-y-6 bg-[var(--bg-primary)] scroll-smooth"
>>>>>>> master
        role="log"
        aria-live="polite"
      >
...
=======
                    <div className={`mb-2 p-2 rounded-lg text-[11px] border-l-4 ${isMe ? 'bg-white/10 border-white/40 text-white/70' : 'bg-[var(--surface-hover)] border-[var(--accent)] text-[var(--text-tertiary)]'
>>>>>>> master
                      }`}>
...
=======
                    <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-[var(--text-primary)] text-[var(--bg-primary)] text-[10px] px-2 py-0.5 rounded-md font-bold animate-in fade-in slide-in-from-bottom-1 duration-200 z-20 flex items-center gap-1">
>>>>>>> master
                    ...
                    <div className="mb-2">
                      {msg.attachment.type.startsWith('image/') ? (
                        <div className="relative group">
                          <img src={msg.attachment.url} alt="" className="max-w-full rounded-lg border border-[var(--border)] mb-1" />
                        </div>
                      ) : (
<<<<<<< HEAD
                        <div className={`flex items-center gap-3 p-2 rounded-xl border ${isMe ? 'bg-white/10 border-white/20' : 'bg-white/5 border-white/10'}`}>
=======
                        <div className={`flex items-center gap-3 p-2 rounded-xl border ${isMe ? 'bg-white/10 border-white/20' : 'bg-[var(--surface)] border-[var(--border)]'}`}>
>>>>>>> master
...
=======
                          className={`p-1.5 rounded-lg ${isMe ? 'text-white/60 hover:bg-white/20' : 'text-[var(--text-tertiary)] hover:bg-[var(--surface-hover)]'} hover:text-[var(--text-primary)] transition-all`}
>>>>>>> master
                          title="Reply"
                        >
                          <Reply size={14} />
...
=======
                <div className={`flex items-center gap-1.5 ${isMe ? 'text-[var(--accent)]' : 'text-[var(--text-tertiary)]'}`}>
>>>>>>> master
...
=======
            <div className="w-6 h-6 rounded-lg bg-[var(--surface)] flex items-center justify-center text-[10px] font-bold text-[var(--text-tertiary)]" aria-hidden="true">{otherInitials}</div>
            <div className="bg-[var(--surface)] text-[var(--text-secondary)] border border-[var(--border)] px-3 py-2 rounded-2xl rounded-tl-none flex items-center gap-2 text-xs">
>>>>>>> master
...
=======
        <div className="px-4 py-2 border-t border-[var(--border)] bg-[var(--accent-muted)] flex items-center justify-between animate-in slide-in-from-bottom-2">
          <div className="flex items-center gap-3 overflow-hidden">
            <div className="w-1 bg-[var(--accent)] h-8 rounded-full"></div>
            <div className="overflow-hidden">
              <p className="text-[10px] font-bold text-[var(--accent)] uppercase tracking-widest">
                Replying to {replyingTo.senderId === currentUser.id ? 'yourself' : (otherUser?.name || otherRoleLabel)}
              </p>
              <p className="text-xs text-[var(--text-secondary)] truncate italic">"{replyingTo.text || 'Attachment shared'}"</p>
>>>>>>> master
            </div>
          </div>
          <button
...
=======
        <div className="px-4 py-3 border-t border-[var(--border)] bg-[var(--surface)] flex flex-col gap-2">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 overflow-hidden">
              <div className="overflow-hidden">
                <p className="text-xs font-bold text-[var(--text-primary)] truncate">{isProcessing ? 'Processing...' : selectedAttachment?.name}</p>
                <p className="text-[10px] text-[var(--text-tertiary)]">{isProcessing ? `${Math.round(uploadProgress || 0)}%` : formatFileSize(selectedAttachment?.size)}</p>
              </div>
            </div>
            {!isProcessing && (
              <button onClick={() => { setSelectedAttachment(null); setUploadProgress(null); }} className="p-1.5 hover:bg-[var(--surface-hover)] rounded-lg text-[var(--text-tertiary)]">
>>>>>>> master
                <X size={14} />
              </button>
            )}
...
=======
      <form onSubmit={handleSend} className="p-3 border-t border-[var(--border)] bg-[var(--bg-secondary)] flex items-center gap-2">
>>>>>>> master
...
=======
          className="p-2.5 text-[var(--text-tertiary)] hover:text-[var(--accent)] transition-all rounded-lg hover:bg-[var(--surface)]"
>>>>>>> master
          title="Attach file"
        >
          <Paperclip size={20} />
