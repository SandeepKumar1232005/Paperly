...
from .views import RegisterView, LoginView, UserDetailsView, RequestPasswordResetView, PasswordResetVerifyView, UserListView, UserManagementView, FileUploadView
